<?php
use App\Http\Controllers\Api\Integrations\ShopifyController;
...
Route::group(['prefix' => 'v1/user'],function(){
    ...
    Route::post('restoreAccount/request', [AuthController::class , 'restoreAccountRequest'])->middleware('guest_check');;
    Route::post('register', [AuthController::class , 'register']);
    Route::post('forgetPasswordStepOne', [AuthController::class , 'forgetPasswordStepOne'])->middleware('guest_check');;
    Route::post('forgetPasswordStepTwo', [AuthController::class , 'forgetPasswordStepTwo'])->middleware('guest_check');;
    Route::post('forgetPasswordStepThree', [AuthController::class , 'forgetPasswordStepThree'])->middleware('guest_check');;
    ...
    Route::group(['middleware' => 'auth'],function(){
        ...
        Route::group(['prefix' => 'games', 'middleware' => 'guest_check'], function(){
        ...
        Route::group(['prefix' => 'orders', 'middleware' => 'guest_check'],function(){
        ...
        Route::group(['prefix' => 'cart'], function() {
            ...
            Route::post('/applycoupn', [CartController::class, 'applycoupn'])->middleware('access_token');
            Route::get('/removecoupon', [CartController::class, 'removecoupon'])->middleware('access_token');
        });

        Route::group(['prefix' => 'profile', 'middleware' => 'guest_check'], function() {
        ...
        Route::group(['prefix' => 'addresses', 'middleware' => 'guest_check'], function() {
        ...
        Route::group(['prefix' => 'paymentcards', 'middleware' => 'guest_check'] ,function(){
        ...
        Route::group(['prefix' => 'product'],function(){
            ...
            Route::get('/favourites',[ProductsController::class,'favourites'])->middleware('guest_check');;
            Route::get('/favourites/togglefavourites/{id}',[ProductsController::class,'togglefavourites'])->middleware('guest_check');
        ...
        Route::group(['prefix' => 'salon'], function(){
            ...
            Route::get('cart', [SalonController::class, 'cart']);
            Route::post('applycoupon', [SalonController::class, 'applycoupon'])->middleware('guest_check');;
            Route::get('removecoupon', [SalonController::class, 'removecoupon'])->middleware('guest_check');
            Route::get('checkout', [SalonController::class, 'checkout'])->middleware('guest_check');
        });
...
Route::post('/shopify/make-order', [ShopifyController::class, 'makeOrder']);
